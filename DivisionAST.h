...
public:
    ...
    Value* Execute() {
        ...
        if(value1->GetValueType() == IntNum && value2->GetValueType() == IntNum) {
            return new Value((float)value1->GetInt() + (float)value2->GetInt(), lineno);
        }
        else if(value1->GetValueType() == IntNum && value2->GetValueType() == LongNum) {
            return new Value((float)value1->GetInt() + (float)value2->GetLong(), lineno);
        }
        else if(value1->GetValueType() == LongNum && value2->GetValueType() == IntNum) {
            return new Value((float)value1->GetLong() + (float)value2->GetInt(), lineno);
        }
        else if(value1->GetValueType() == LongNum && value2->GetValueType() == LongNum) {
            return new Value((float)value1->GetLong() + (float)value2->GetLong(), lineno);
        }

        else if(value1->GetValueType() == FloatNum && value2->GetValueType() == FloatNum) {
            return new Value((float)value1->GetFloat() + (float)value2->GetFloat(), lineno);
        }
        else if(value1->GetValueType() == FloatNum && value2->GetValueType() == DoubleNum) {
            return new Value((float)value1->GetFloat() + (float)value2->GetDouble(), lineno);
        }
        else if(value1->GetValueType() == DoubleNum && value2->GetValueType() == FloatNum) {
            return new Value((float)value1->GetDouble() + (float)value2->GetFloat(), lineno);
        }
        else if(value1->GetValueType() == DoubleNum && value2->GetValueType() == DoubleNum) {
            return new Value((float)value1->GetDouble() + (float)value2->GetDouble(), lineno);
        }
